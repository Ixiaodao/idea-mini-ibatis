package net.ishchenko.idea.minibatis.annotation;
...
public class Annotation implements Cloneable {
    ...
    public static final Annotation ALIAS = new Annotation("@Alias", "com.zuche.framework.annotation.IbatisAliasConfig");
    ...
    public java.util.Optional<PsiClass> toPsiClass(@NotNull Project project) {
        return java.util.Optional.ofNullable(JavaPsiFacade.getInstance(project).findClass(getQualifiedName(), GlobalSearchScope.allScope(project)));
    }
